...
<div style="background:#fff">
    <div style="max-width:100%;margin:0 auto;">
                    ...
                    <p style="margin:0;margin-bottom:.0001pt;line-height:111%">
                        <b>
                            <span style="font-size:19.0pt;line-height:111%;font-family:Arial,sans-serif">
                                {{ trans('message.feedback.email.title', ['purchasing_category' => $purchasing_category ?? '']) }}
                            </span>
                        </b>
                    </p>
                </td>
        ...
        <table border="0" cellpadding="0" style="max-width:420.0pt">
            ...
            @php
                $data = [
                    trans('message.feedback.email.name') => $name ?? '',
                    trans('message.feedback.email.section') => $section ?? '',
                    trans('message.feedback.email.purchasing_category') => $purchasing_category ?? '',
                    trans('message.feedback.email.question') => $question ?? '',
                ];
            @endphp
